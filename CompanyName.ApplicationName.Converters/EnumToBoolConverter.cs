...
namespace CompanyName.ApplicationName.Converters
{
    ...
    public class EnumToBoolConverter : IValueConverter
    {
        ...
        /// <summary>
        /// Converts a true boolean value into the Enum instance specified by the parameter input parameter and a false boolean value into null.
        /// </summary>
        /// <param name="value">The value that is produced by the binding target.</param>
        /// <param name="targetType">The type to convert to.</param>
        /// <param name="parameter">The converter parameter to use.</param>
        /// <param name="culture">The culture to use in the converter.</param>
        /// <returns>The Enum instance specified by the parameter input parameter if the input value is true, or null otherwise.</returns>
