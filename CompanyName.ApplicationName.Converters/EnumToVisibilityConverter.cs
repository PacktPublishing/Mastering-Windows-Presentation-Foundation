...
namespace CompanyName.ApplicationName.Converters
{
    ...
    public class EnumToVisibilityConverter : BaseVisibilityConverter, IValueConverter
    {
        ...
        /// <summary>
        /// Converts a System.Windows.Visibility value into an Enum value dependant on the value and parameter input parameters and the IsInverted property.
        /// </summary>
        /// <param name="value">The value that is produced by the binding target.</param>
        /// <param name="targetType">The type to convert to.</param>
        /// <param name="parameter">The converter parameter that determines the output of the IValueConverter.</param>
        /// <param name="culture">The culture to use in the converter.</param>
        /// <returns>A boolean value dependant on the boolean input value and the IsInverted property.</returns>
