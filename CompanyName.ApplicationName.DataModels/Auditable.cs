...
namespace CompanyName.ApplicationName.DataModels
{
    ...
    public class Auditable : BaseDataModel
    {
        ...
        /// <summary>
        /// Initialises a new Auditable object with the values from the input parameters.
        /// </summary>
        ...
        /// <param name="updatedOn">The date and time that the Auditable object was last updated.</param>
        ...
        /// <summary>
        /// Initialises a new Auditable object with the value from the input parameter.
        /// </summary>
        /// <param name="createdBy">The User object that created this Auditable object.</param>
        public Auditable(User createdBy) : this(DateTime.Now, createdBy, null, new User()) { }

        /// <summary>
        /// Initialises a new empty Auditable object.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the date and time that this object was last updated.
        /// </summary>
        ...
        /// <summary>
        /// Returns a string that represents the current Auditable object.
        /// </summary>
        /// <returns>A string that represents the current User object.</returns>
