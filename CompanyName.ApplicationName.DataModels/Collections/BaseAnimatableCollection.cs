...
{
    /// <summary>
    /// Represents a dynamic, sortable data collection that provides notifications when items get added and removed, maintains a current item and provides members that enable the animation of its items.
    /// </summary>
    ...
    public class BaseAnimatableCollection<T> : BaseCollection<T> where T : class, IAnimatable, INotifyPropertyChanged, new()
    {
        ...
        /// <summary>
        /// Initialises a new BaseCollection object and adds the items from the collection specified by the input parameter.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new empty BaseCollection object.
        /// </summary>
        ...
        /// <summary>
        /// Removes all elements from the Midas.DataTypes.Collections.BaseAnimatableCollection&lt;T&gt;.
        /// </summary>
