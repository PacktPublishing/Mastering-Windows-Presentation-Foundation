...
{
    /// <summary>
    /// Represents a dynamic, sortable data collection that provides notifications when items get added and removed, maintains a current item and provides a number of helpful utility methods.
    /// </summary>
