...
namespace CompanyName.ApplicationName.DataModels.Collections
{
    ...
    {
        /// <summary>
        /// Initialises a new FeedbackCollection collection and adds the Feedback objects from the collection specified by the feedbackCollection input parameter.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new empty FeedbackCollection collection.
        /// </summary>
        public FeedbackCollection() : base() { }
        
        /// <summary>
        /// Adds an object to the end of the collection if it is not already in the collection.
        /// </summary>
