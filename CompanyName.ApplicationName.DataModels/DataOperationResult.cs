...
namespace CompanyName.ApplicationName.DataModels
{
    ...
    {
        /// <summary>
        /// Initialises a new DataOperationResult with the values provided by the input parameters.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new DataOperationResult with the values provided by the input parameters in cases where an Exception occurred during the data operation.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new DataOperationResult in cases where an Exception occurred during the data operation.
        /// </summary>
        /// <param name="exception">The Exception that occurred during the data operation.</param>
