...
namespace CompanyName.ApplicationName.DataModels
{
    ...
    public class Feedback : IAnimatable, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Initialises a new Feedback object with the values provided by the input parameters.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new Feedback object with the values provided by the input parameters. Note that this constructor only enables FeedbackType.Success and FeedbackType.Error types. 
        /// </summary>
        /// <param name="message">The message of the Feedback object.</param>
        /// <param name="isSuccess">The value that specifies whether the Feedback object has a FeedbackType of FeedbackType.Success or FeedbackType.Error.</param>
        ...
        /// <summary>
        /// Initialises a new empty Feedback object.
        /// </summary>
