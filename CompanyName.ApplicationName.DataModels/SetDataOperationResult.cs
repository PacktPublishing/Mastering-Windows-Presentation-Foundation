...
namespace CompanyName.ApplicationName.DataModels
{
    ...
    {
        /// <summary>
        /// Initialises a new SetDataOperationResult with the values provided by the input parameters in cases where an Exception occurred during the data operation.
        /// </summary>
        ...
        /// <summary>
        /// Initialises a new SetDataOperationResult with the values provided by the input parameters.
        /// </summary>
        /// <param name="successText">The feedback text to display in the case of a successful data operation.</param>
        /// <param name="errorText">The feedback text to display in the case of an unsuccessful data operation.</param>
