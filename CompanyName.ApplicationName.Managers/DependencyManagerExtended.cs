...
namespace CompanyName.ApplicationName.Managers
{
    ...
    /// </summary>
    public class DependencyManagerExtendedExtended
    {
        private static DependencyManagerExtendedExtended instance;
        private static DependencyRegistrations registeredDependencies = new DependencyRegistrations();

        private DependencyManagerExtendedExtended() { }

        /// <summary>
        /// Gets the single available instance of the application DependencyManagerExtended object.
        /// </summary>
        public static DependencyManagerExtendedExtended Instance
        {
            get { return instance ?? (instance = new DependencyManagerExtendedExtended()); }
        }
