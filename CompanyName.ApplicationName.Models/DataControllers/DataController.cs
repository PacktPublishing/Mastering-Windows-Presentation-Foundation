...
namespace CompanyName.ApplicationName.Models.DataControllers
{
    ...
    public class DataController
    {
        ...
        /// <summary>
        /// Initialises a new DataController with the values from the input parameters.
        /// </summary>
        ...
        {
            return DataOperationManager.TrySetAsync(() => DataProvider.AddProduct(InitialiseDataModel(product)), $"{product.Name} was added to the data source successfully", $"A problem occurred and {product.Name} was not added to the data source.");
        }
        ...
        private T InitialiseDataModel<T>(T dataModel) where T : class, IAuditable, new()
        {
