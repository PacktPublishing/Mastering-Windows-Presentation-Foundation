...
{
    /// <summary>
    /// Wraps a business User object and adds additional properties that are required to enable the editing of the internal User object in the UI.
    /// </summary>
    public class UserViewModel : BaseBusinessViewModel
    {
        ...
        /// <summary>
        /// Initialises a new UsersViewModel object with the value specified by the input parameter.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value that specifies whether the User object that is wrapped by this class is selected in the UI or not.
        /// </summary>
