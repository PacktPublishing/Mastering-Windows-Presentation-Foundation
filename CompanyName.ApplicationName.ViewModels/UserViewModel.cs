...
namespace CompanyName.ApplicationName.ViewModels
{
    ...
    {
        private User user = new User(Guid.NewGuid(), "John Smith", 25) { Address = new Address() { HouseAndStreet = "147 Lucile Street", Town = "Somertown", City = "London", PostCode = "NW17 9RL", Country = "England" } };
