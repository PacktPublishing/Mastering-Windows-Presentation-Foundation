...
namespace CompanyName.ApplicationName.Views.Controls
{
    ...
    public class FormattedTextOutput : FrameworkElement
    {
        ...
        {
            FormattedText formattedText = new FormattedText(Text, CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, new Typeface("Times New Roman"), 50, Brushes.Red);
