...
{
    /// <summary>
    /// Provides an easy way to output a smiley face as a graphical object extending a Visual object.
    /// </summary>
    public class SmileyFaceVisual : Visual
    {
